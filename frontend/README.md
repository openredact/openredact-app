...
Before anything else make sure to install the dependencies (including development dependencies).
...
You can serve the build by running:
...
Lint code using eslint. Eslint is configured in `package.json`.
